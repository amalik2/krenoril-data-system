...
Krenoril Data System is an in-memory, NoSQL data store that is meant for games that use a data-driven approach for development. It allows you to store almost arbitrary game data under specific schemas in JSON files, and it loads those files at runtime. Schemas and records are modifiable through a free desktop application called Krenoril Data Editor, built with React and Electron. This was built to make it easy for game developers to add in basic mod support to their games. An official implementation of a plugin that uses the data generated by this application can be found [here for Unreal Engine 4](https://www.unrealengine.com/marketplace/en-US/product/krenoril-data-system)

The documentation can be found [here](https://amalik2.github.io/krenoril-data-system/)
...
- Visit [this page](https://amalik2.github.io/krenoril-data-system/developers/setup.html), and follow the instructions there to set up the application
- Visit [this page](https://amalik2.github.io/krenoril-data-system/developers/adminUsageInstructions.html), and follow the instructions there to learn how to use the application
...
As a player who wants to add mods to a game that uses Krenoril Data System, follow these steps:
 ...
 - Extract `krenoril-data-editor.rar`
 - Visit [this page](https://amalik2.github.io/krenoril-data-system/players/userUsageInstructions.html), and follow the instructions there to learn how to set up and use the application
...
## API
Functions for working with the data that is loaded exist for both C++ and Blueprint. Example usages can be found on [this page](https://amalik2.github.io/krenoril-data-system/developers/adminUsageInstructions.html)
...
More details about data scripts can be [found here](https://amalik2.github.io/krenoril-data-system/dataScripts.html)  
